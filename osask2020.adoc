...
`z_tools/guigui00/stdlib.h` に次のパッチ link:osask2020_stdlib.diff[osask2020_stdlib.diff] を当てます。


`28GO_K_0033/gg00libc/` に次のパッチ link:osask2020_gg00libc.diff[osask2020_gg00libc.diff] を当てます。
`pushd 28GO_K_0033/gg00libc/` のと `make` すると `28GO_K_0033/gg00libc/gg00libc.lib` が生成されます。
 `28GO_K_0033/gg00libc/gg00libc.lib` を `z_tools/gg00libc/gg00libc.lib` にコピーします。
執筆中...
...
.WIN95 風モードにしたところ
image::./osask2020_0.png[OSASK を WIN95 風にて起動させたところ]
